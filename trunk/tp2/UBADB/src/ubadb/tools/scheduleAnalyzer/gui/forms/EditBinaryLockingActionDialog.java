...
public class EditBinaryLockingActionDialog extends javax.swing.JDialog {
    
	private BinaryLockingAction selectedAction = null;
    
    /** Creates new form SelectScheduleTypeDialog 
     * @param items */
    public EditBinaryLockingActionDialog(java.awt.Frame parent, boolean modal, List<String> transactions, List<String> items)
    {
        super(parent, modal);
        initComponents();
    ...
    {//GEN-FIRST:event_butAceptarMouseClicked
    	...
    	{
    		selectedAction = new BinaryLockingAction(BinaryLockingActionType.LOCK,
				(String)cbTransaction.getSelectedItem(),
				(String)cbItem.getSelectedItem());
    	}
    	else if(rbUnlock.isSelected())
    	{
    		selectedAction = new BinaryLockingAction(BinaryLockingActionType.UNLOCK,
    				(String)cbTransaction.getSelectedItem(),
    				(String)cbItem.getSelectedItem());
    	}
    	else if(rbCommit.isSelected())
    	{
    		selectedAction = new BinaryLockingAction(BinaryLockingActionType.COMMIT,
    				(String)cbTransaction.getSelectedItem());
    	}
    ...
    public static BinaryLockingAction showDialog(Frame parent, List<String> transactions, List<String> items)
    {
    	EditBinaryLockingActionDialog dialog = new EditBinaryLockingActionDialog(parent, true, transactions, items);
